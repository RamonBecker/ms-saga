...
public class KafkaConfig {
    ...
    private Map<String, Object> producerProperties() {
        ...
        defaultProperties.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaProperties.getConsumer().getAutoOffsetReset());
    ...
    public NewTopic createPaymentSuccessTopic() {
        return builderTopic(kafkaProperties.getTopic().getPaymentSuccess());
    }

    @Bean
    public NewTopic createPaymentFailTopic() {
        return builderTopic(kafkaProperties.getTopic().getPaymentFail());
    }
