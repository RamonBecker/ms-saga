...
import static com.payment.service.infrastructure.shared.constants.TopicKafkaConfig.BOOTSTRAP_SERVERS;
import static com.payment.service.infrastructure.shared.constants.TopicKafkaConfig.AUTO_OFFSET_RESET;
import static com.payment.service.infrastructure.shared.constants.TopicKafkaConfig.GROUP_ID;
import static com.payment.service.infrastructure.shared.constants.TopicKafkaConfig.PAYMENT_SUCCESS;
import static com.payment.service.infrastructure.shared.constants.TopicKafkaConfig.PAYMENT_FAIL;
...
public class KafkaConfig {
    ...
    private Map<String, Object> producerProperties() {
        ...
        defaultProperties.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, AUTO_OFFSET_RESET);
    ...
    public NewTopic createPaymentSuccessTopic() {
        return builderTopic(PAYMENT_SUCCESS);
    }

    @Bean
    public NewTopic createPaymentFailTopic() {
        return builderTopic(PAYMENT_FAIL);
    }
